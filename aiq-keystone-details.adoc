...
[%collapsible]
====
Wenn Sie den Datenschutzdienst abonniert haben, können Sie die Aufschlüsselung der Verbrauchsdaten für die MetroCluster-Partnerseiten auf der Registerkarte *Abonnementzeitreihen* einsehen.
